...
Similar to the previous test, we obtain the evaluation for the `test_index` index (i.e., QQQ data from 2018 to 2022). We get all
...
For our first test set (i.e., SPY from 2022 to 2023)
...
For our second test set (i.e., QQQ data from 2018 to 2022)
