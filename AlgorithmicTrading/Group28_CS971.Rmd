...
```{r}
plot_graph(cumsum(pool_signals), as.xts(pool_signals), colnames(pool_signals), "Cumulative sum of signals", "Date", "Cumulative sum of signals")
```
...
```{r}
plot_graph(cumsum(all_signals), as.xts(all_signals), colnames(all_signals), "Signals", "Date", "Signal")
```
